/**
 * FuelGaugePage — placeholder; SOC estimator view / drift / reset actions.
 */
...
export function FuelGaugePage() {
  ...
  return (
    <ShellLayout
      ...
      onPlot={onPlot}
    >
      <div className="panel-header">Fuel Gauge</div>
      <div style={{ padding: 12 }}>TODO: SOC estimator view / drift / reset actions</div>
    </ShellLayout>
  )
}
