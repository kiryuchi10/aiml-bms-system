/**
 * SafetyPage — placeholder; contactor / precharge / HVIL / insulation.
 */
...
export function SafetyPage() {
  ...
  return (
    <ShellLayout
      ...
      onPlot={onPlot}
    >
      <div className="panel-header">Safety / PMDU</div>
      <div style={{ padding: 12 }}>TODO: contactor / precharge / HVIL / insulation</div>
    </ShellLayout>
  )
}
