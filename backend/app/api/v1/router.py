...
from app.api.v1.endpoints import telemetry, dashboard, analytics, ml, cells, alarms, ingest, features
from app.api.v1 import ws_bms

v1_router = APIRouter()

v1_router.include_router(ingest.router, prefix="/ingest", tags=["v1-ingest"])
v1_router.include_router(features.router, prefix="/features", tags=["v1-features"])
...
v1_router.include_router(alarms.router, prefix="/alarms", tags=["v1-alarms"])
